...
const totalContributions = GAMES_JSON.reduce((acc, cont) =>{
    return acc + cont.backers;
}, 0)

// set the inner HTML using a template literal and toLocaleString to get a number with commas
contributionsCard.innerHTML = totalContributions.toLocaleString("us-EL");
...
raisedCard.innerHTML = '$' + totalRaised.toLocaleString("us-EL");
...
const unf = `
A total of ${totalRaised.toLocaleString("us-EL")} has been raised for ${GAMES_JSON.length} games. 
Currently, ${unfundedCount.length} ${unfundedCount === 1 ? "game remains" : "games remain"} unfunded. 
We need your help to fund these amazing games!`;

// create a new DOM element containing the template string and append it to the description container
const unfundedParagraph = document.createElement("p");
unfundedParagraph.textContent = unf;
